...
> => ({
  ...
  ownedNotes: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ownedNotes',
      label: i18nLabel(msg`Owned notes`),
      description: i18nLabel(msg`Notes owned by the workspace member`),
      icon: 'IconNotes',
      isNullable: false,
      isUIEditable: false,
